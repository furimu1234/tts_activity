...
import { darkTheme, globalCss, styled } from '../styled';
...
const global = globalCss({
	...
	':root': {
		...
		'--saib':
			'var(--discord-safe-area-inset-bottom, env(safe-area-inset-bottom))',
		'--sail': 'var(--discord-safe-area-inset-left, env(safe-area-inset-left))',
		'--sair':
			'var(--discord-safe-area-inset-right, env(safe-area-inset-right))',
	},
	body: {
		paddingTop: 'var(--sait)',
...
export default function DesignSystemProvider({
	...
	return (
		<Container className={resolvedTheme === 'dark' ? darkTheme : undefined}>
			{children}
		</Container>
	);
}
